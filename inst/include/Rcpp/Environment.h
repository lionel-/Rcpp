...
namespace Rcpp{
    ...
    private:
        inline SEXP as_environment(SEXP x){
            ...
            try {
                Shield<SEXP> res(evalProtect(Rf_lang2(asEnvironmentSym, x), R_GlobalEnv));
                return res ;
        ...
        */
        ...
        static Environment_Impl namespace_env(const std::string& package){
            ...
            try{
                ...
                env = evalProtect(Rf_lang2(getNamespaceSym, package_str), R_GlobalEnv);
            } catch( ... ){
        ...
        Environment_Impl new_child(bool hashed) const {
            ...
            return Environment_Impl(evalProtect(Rf_lang3(newEnvSym, Rf_ScalarLogical(hashed), Storage::get__()), R_GlobalEnv));
        }
