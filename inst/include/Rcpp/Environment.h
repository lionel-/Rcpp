...
namespace Rcpp{
    ...
    private:
        inline SEXP as_environment(SEXP x){
            ...
            try {
                Shield<SEXP> res(Rcpp_fast_eval(Rf_lang2(asEnvironmentSym, x), R_BaseEnv));
                return res ;
        ...
        */
        ...
        static Environment_Impl namespace_env(const std::string& package){
            ...
            try{
                ...
                Shield<SEXP> ns_call(Rf_lang2(getNamespaceSym, package_str));
                env = Rcpp_fast_eval(ns_call, R_BaseEnv);
            } catch( ... ){
        ...
        Environment_Impl new_child(bool hashed) const {
            ...
            return Environment_Impl(Rcpp_fast_eval(Rf_lang3(newEnvSym, Rf_ScalarLogical(hashed), Storage::get__()), R_BaseEnv));
        }
